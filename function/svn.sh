...
#文档：https://blog.csdn.net/wl_1013/article/details/80956329
svn_install_1_10(){
...
cd $install_dir/
wget http://mirrors.tuna.tsinghua.edu.cn/apache/subversion/subversion-1.10.6.tar.bz2
wget https://www.sqlite.org/2018/sqlite-amalgamation-3240000.zip
tar -jx -f subversion-1.10.0.tar.bz2
unzip sqlite-amalgamation-3240000.zip -d $svn_path
cd subversion-1.10.6
mv ../sqlite-amalgamation-3240000 sqlite-amalgamation
./configure --prefix=/usr/local/svn  --with-apr=/usr/local/apr --with-apr-util=/usr/local/apr-util --with-sqlite=/opt/subversion-1.10.6/sqlite-amalgamation/sqlite3.c --with-lz4=internal --with-utf8proc=internal
make
make install
